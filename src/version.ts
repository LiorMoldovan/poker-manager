...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-21',
    changes: [
      '⚡ Align location totals with rounded games',
    ],
  },
  {
    version: '6.34.0',
  ...
  },
  {
    ...
    date: '2026-09-21',
    changes: [
      '⚡ One-click browser launch and copy for IDE login',
    ],
  },
  {
    version: '6.33.1',
    date: '2026-09-20',
    changes: [
      '⚡ Seamless Google auth bridge in Antigravity UI',
    ],
  },
  {
    version: '6.33.0',
    date: '2026-09-20',
    changes: [
      '📍 Location performance comparison matrix in stats',
      '👑 Best earner highlight per game location',
      '📸 Image share button for location matrix',
    ],
  },
  {
    version: '6.32.0',
  ...
  },
  {
    ...
    date: '2026-09-06',
    changes: [
      '👥 Poll timer shows which regulars are missing',
      '💡 Host suggestion lists all venue options',
      '📅 Host suggestion shows the date it ranks',
      '📍 Only saved venues offered for hosting',
      '🏠 Shelter venue no longer merged into a player',
    ],
  },
  {
    version: '6.26.0',
    date: '2026-09-06',
    changes: [
      '🔔 Poll opening alert now reaches everyone',
      '🎉 "Game is full" alert to the whole group',
      '📱 Phone and PC no longer cancel each other',
      '🔕 Fewer missed alerts from lost registrations',
    ],
  },
  {
    version: '6.25.0',
  ...
  },
  {
    ...
    date: '2026-08-25',
    changes: [
      '🪑 No guest invites when picked date is full',
    ],
  },
  {
    version: '6.24.0',
  ...
  },
  {
    ...
    date: '2026-07-12',
    changes: [
      '🐛 Fix crash when ending a game',
      '📱 Slimmer chip-count bar on mobile',
      '🔢 Count verdict worded in chips',
    ],
  },
  {
    version: '6.21.0',
  ...
  },
  {
    ...
    date: '2026-07-05',
    changes: [
      '📊 Half buy-ins show exact in stats (no rounding)',
    ],
  },
  {
    version: '6.18.2',
    date: '2026-06-28',
    changes: [
      '🛡 Half buy-ins now save correctly',
      '🩹 Game no longer lost when using ½ buy-in',
    ],
  },
  {
    version: '6.18.1',
    date: '2026-06-23',
    changes: [
      '🩹 Small chip stacks no longer collapse to 0k/1k',
      '📱 Chip totals exact for low-value games',
    ],
  },
  {
    version: '6.18.0',
    date: '2026-06-15',
    changes: [
      '🎟 Guests invited only when a seat is free',
      '🛡 A regular\'s "maybe" holds a seat first',
      '🤫 Dropped the "reserved for regulars" note',
      '🔔 New-vote push differs from a vote change',
    ],
  },
  {
    version: '6.17.2',
    date: '2026-06-14',
    changes: [
      '🗓 Auto-schedule no longer opens the poll twice',
      '🛡 Server cron is now the only poll opener',
    ],
  },
  {
    version: '6.17.1',
  ...
  },
  {
    ...
    date: '2026-06-09',
    changes: [
      '🧪 Test your personal Gemini key',
      '⚠️ Forecast shows the real key error',
    ],
  },
  {
    version: '6.16.0',
  ...
  },
  {
    ...
    date: '2026-06-08',
    changes: [
      '🩹 Fix rare "loading stuck" screen on slow connections',
    ],
  },
  {
    version: '6.14.1',
    date: '2026-06-08',
    changes: [
      '📱 Schedule defaults fit a tidy 2×2 on mobile',
    ],
  },
  {
    version: '6.14.0',
  ...
  },
  {
    ...
    date: '2026-06-07',
    changes: [
      '🕐 Poll shows the date & time it opened',
    ],
  },
  {
    version: '6.13.0',
  ...
  },
  {
    ...
    date: '2026-06-07',
    changes: [
      '📊 Profit gap to the player above',
      '🎛 Toggle to show/hide the gap',
      '🐛 Accurate rank-movement arrows',
      '📐 Fixed dropdown alignment in RTL',
      '🔧 Clearer rank-movement arrow',
    ],
  },
  {
    version: '6.9.2',
    date: '2026-06-03',
    changes: [
      '🧭 Waze opens the app, not the web page',
      '📱 Reliable navigation from the home-screen app',
    ],
  },
  {
    version: '6.9.1',
    date: '2026-06-03',
    changes: [
      '✨ Cleaner Waze + arrival-details pills on game cards',
      '📐 Better spacing on the upcoming-game card',
    ],
  },
  {
    version: '6.9.0',
  ...
  },
  {
    ...
    date: '2026-05-23',
    changes: [
      '🔒 Email-kind toggles stick — no more silent resets',
      '📱 Home stat labels wrap on narrow phones',
    ],
  },
  {
    version: '6.8.8',
    date: '2026-05-23',
    changes: [
      '🛠 Fixed "Save failed" toast when completing a game',
    ],
  },
  {
    version: '6.8.7',
  ...
  },
  {
    ...
    date: '2026-05-18',
    changes: [
      '🔧 Confirmed-date banner: hide "opens to all in…" once seats are full',
    ],
  },
  {
    version: '6.8.2',
  ...
  },
  {
    ...
    date: '2026-05-17',
    changes: [
      '🔧 Dark popover dropdowns: render above all overlays (no more hidden menus)',
    ],
  },
  {
    version: '6.8.0',
  ...
  },
  {
    ...
    date: '2026-05-16',
    changes: [
      '📊 Stats sort/mode dropdowns: same dark popover as period',
    ],
  },
  {
    version: '6.7.2',
    date: '2026-05-16',
    changes: [
      '📅 Stats period dropdown: dark themed popover (no more OS white box on mobile)',
    ],
  },
  {
    version: '6.7.1',
    date: '2026-05-16',
    changes: [
      '🏆 Podium card: same 2-column layout as main stats',
    ],
  },
  {
    version: '6.7.0',
    date: '2026-05-16',
    changes: [
      '🗳️ Poll voter toggle: colored ✓/?/✕ breakdown',
      '📊 Stats period selector: native dropdown across all tables',
      '🎛️ Stats: header chrome unified across 5 tables',
      '🏆 Main stats card: 2-column control layout',
    ],
  },
  {
    version: '6.6.2',
    date: '2026-05-16',
    changes: [
      '🏅 Main stats table now has a title like the other tables',
    ],
  },
  {
    version: '6.6.1',
  ...
  },
  {
    ...
    date: '2026-05-16',
    changes: [
      '🏁 Avg placement: best/worst now whole numbers, not 4.5',
    ],
  },
  {
    version: '6.5.0',
  ...
  },
  {
    ...
    date: '2026-05-16',
    changes: [
      '📐 Poll tile header no longer wraps to 3 lines on narrow phones',
    ],
  },
  {
    version: '6.4.1',
  ...
  },
  {
    ...
    date: '2026-05-16',
    changes: [
      '🛠️ Backspace clears schedule config inputs cleanly',
      '🔓 Admins can release a locked-in date back to voting',
      '🚫 Admins can exclude dates without losing votes',
      '⏱️ Expansion clock keeps running through mid-poll pins',
    ],
  },
  {
    version: '6.3.1',
    date: '2026-05-16',
    changes: [
      '✏️ Count cells can be cleared to empty before retyping',
      '🎯 AI now self-rates confidence per color (not a constant 80%)',
      '📐 Overall confidence reflects the average, not a weighted hack',
    ],
  },
  {
    version: '6.3.0',
    date: '2026-05-16',
    changes: [
      '✏️ Editable counts on the photo test — fix any wrong number in place',
      '✓ "Save correct count" button stores the photo + truth for prompt tuning',
    ],
  },
  {
    version: '6.2.1',
  ...
  },
  {
    ...
    date: '2026-05-15',
    changes: [
      '🛡 Hardened super-admin observer mode — full read-only',
      '🚫 Cache write kill-switch blocks every group write',
      '🤖 AI / TTS / email / push blocked for observers',
      '👁 Global observer banner on every screen',
      '🧱 4 more read RPCs accept super-admin observers',
    ],
  },
  {
    version: '6.1.1',
    date: '2026-05-15',
    changes: [
      '🛡 Fix: super-admin observer wiping group settings',
      '🔧 Settings load now respects super-admin observer mode',
      '🧱 Non-owner admins now see full settings (3 missing fields)',
      '👁 Observer banner explains read-only settings tab',
    ],
  },
  {
    version: '6.1.0',
    date: '2026-05-15',
    changes: [
      '🎚 Mixed-mode toggle on chip-entry screen',
      '🧹 Clean single-mode tiles when mixed mode is off',
      '🏷 Page subtitle shows current counting method',
      '💬 Hint names the active method explicitly',
      '🔁 Reusable ToggleSwitch shared across screens',
    ],
  },
  {
    version: '6.0.0',
  ...
  },
  {
    ...
    date: '2026-05-15',
    changes: [
      '🩹 Fix: phantom horizontal scroll on podium card',
    ],
  },
  {
    version: '5.62.7',
    date: '2026-05-15',
    changes: [
      '🩹 Fix: vertical scroll restored on iPhone',
      '🛠 overflow-x: clip instead of hidden on html/body',
    ],
  },
  {
    version: '5.62.6',
  ...
  },
  {
    ...
    date: '2026-05-15',
    changes: [
      '🎯 Chip count fix: disabled Gemini thinking tokens that were truncating JSON mid-response',
      '⬆️ Raised photo response token budget so counts can\'t be cut off',
    ],
  },
  {
    version: '5.62.4',
  ...
  },
  {
    ...
    date: '2026-05-15',
    changes: [
      '🩹 Chip-count parser: 5-strategy salvager (JSON, fences, regex, plain text)',
      '🔍 Photo errors now show the raw AI response so we can see what went wrong',
      '✂️ Simpler chip-count prompt — removed confusing <integer> placeholder',
    ],
  },
  {
    version: '5.62.2',
  ...
  },
  {
    ...
    date: '2026-05-15',
    changes: [
      '🎯 Chip counting now matches via your configured swatch color',
      '🧹 Retired the unreliable selfie color extraction',
      '📷 Selfies still used as the LLM reference image (their real value)',
      '🛟 Robust mapping regardless of photo lighting / framing',
    ],
  },
  {
    version: '5.60.13',
  ...
  },
  {
    ...
    date: '2026-05-10',
    changes: [
      '🎯 Chip photo: Pro model + 3-shot consensus',
      '🔍 Computed confidence cap 90%, anti-undercount prompting',
      '💡 Photo tips collapsible in capture modal',
      '🛠 Feedback loop: silent diff capture on Done',
      '🔒 Owner opt-in to share photos for tuning',
      '🚩 Trivia report shows label not just flag',
      '🎲 Trivia: wider number-guess distractors',
    ],
  },
  {
    version: '5.52.0',
  ...
  },
  {
    ...
    date: '2026-05-10',
    changes: [
      '📤 Share trivia leaderboard as PNG via WhatsApp',
    ],
  },
  {
    version: '5.51.0',
  ...
  },
  {
    ...
    date: '2026-05-10',
    changes: [
      '🎯 Trivia: lock answer correctness at click time',
      '🛡 Fixes rare 0/10 score bug from stale state',
      '🔍 Diagnostic log on suspicious 0-score sessions',
    ],
  },
  {
    version: '5.50.1',
    date: '2026-05-10',
    changes: [
      '🎮 Trivia cards open landing with 🎲 הכל preselected',
    ],
  },
  {
    version: '5.50.0',
  ...
  },
  {
    ...
    date: '2026-05-09',
    changes: [
      '🩹 Photo button now smart about env-var fallback',
      '📷 Hidden mid-game only when AI truly unavailable',
      '💬 Test card explains both "no key" and "no chips"',
    ],
  },
  {
    version: '5.47.1',
  ...
  },
  {
    ...
    date: '2026-05-07',
    changes: [
      '🩹 Remove duplicate "+" on Add Chip button',
    ],
  },
  {
    version: '5.44.4',
  ...
  },
  {
    ...
    date: '2026-05-07',
    changes: [
      '📧 Email tester shows real error reason',
      '📧 Guests get email when poll expands',
      '🎯 No duplicate "המשחק מלא" email after below-target pin',
      '🤐 Skip recruitment email to no-voters on pinned date',
      '🔒 Auto-lock voting when seat target filled',
      '👁 Super-admin cross-group observer mode (foundation)',
    ],
  },
  {
    version: '5.44.1',
  ...
  },
  {
    ...
    date: '2026-05-06',
    changes: [
      '🔁 EmailJS /history cross-check (last 7 days)',
      '✓ Usage card shows in-sync vs logger gap',
      '🤝 Self-log validated against EmailJS upstream',
    ],
  },
  {
    version: '5.43.1',
  ...
  },
  {
    ...
    date: '2026-05-05',
    changes: [
      '🩹 Removed duplicate emoji on home cards',
    ],
  },
  {
    version: '5.39.0',
  ...
  },
  {
    ...
    date: '2026-05-05',
    changes: [
      '✨ Tap-to-cycle on home trivia card',
      '🎚 Fade transition between trivia facts',
  ...
  },
  {
    ...
    date: '2026-05-04',
    changes: [
      '🛡 Join-request banner: pick existing player on accept',
      '🎯 Auto-suggests player by email match',
      '🛡 Closes duplicate-player join path',
    ],
  },
  {
    version: '5.37.2',
    date: '2026-05-04',
    changes: [
      '🩹 Auto-poll day picker fits one row on mobile',
    ],
  },
  {
    version: '5.37.1',
