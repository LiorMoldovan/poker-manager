...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2024-12-14',
    changes: [
      'Removed Reset All Statistics button from statistics page'
    ]
  },
  {
    version: '2.2.4',
    date: '2024-12-14',
    changes: [
      'Progress bar increased to 36px with chip count text overlay'
    ]
  },
  {
    version: '2.2.3',
  ...
  },
  {
    ...
    date: '2024-12-14',
    changes: [
      'Added app version display to PIN login screen'
    ]
  },
  {
    version: '2.2.1',
  ...
  },
  {
    ...
    date: '2024-12-14',
    changes: [
      'Much bigger progress bar (18px) with chip count overlay',
      'Significantly reduced gap - padding 75px',
      'Removed stats row, cleaner bottom bar'
    ]
  },
  {
    version: '2.1.8',
