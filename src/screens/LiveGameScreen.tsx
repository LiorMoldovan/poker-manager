...
const LiveGameScreen = () => {
  ...
  const getBuyinMessage = (totalBuyins: number, isQuickRebuy: boolean): string => {
    ...
    const messages: Record<number, string[]> = {
      1: [
        // First rebuy - encouraging (25+ messages)
        'הכל יהיה בסדר',
        ...
        'קורה לטובים ביותר',
        'ריסטארט, בוא נלך',
        'עכשיו עם יותר ניסיון',
        'פעם ראשונה לא נחשבת',
        'חימום נגמר, עכשיו ברצינות',
        'זה היה רק אימון',
        'עכשיו יודעים מי על השולחן',
        'למדנו משהו, נמשיך',
        'הסטאק הראשון היה ניסוי',
        'עכשיו עם המידע הנכון',
        'בוא נראה מה יש',
        'סבבה, הלאה',
        'יופי, עוד סיבוב',
        'נתחיל מחדש',
      ...
      2: [
        // Second rebuy - still positive (20+ messages)
        'לא נורא, יהיה בסדר',
        'זה קורה לכולם',
        'עדיין בתחילת הדרך',
        'אין מה לדאוג',
      ...
      3: [
        // Third rebuy - mild concern (20+ messages)
        'פעם שלישית גלידה',
      ...
      4: [
        // Fourth rebuy - concern (15+ messages)
        'כבר ארבע, שימו לב',
        'מתחיל להיות יקר',
        'אולי הפסקה קטנה',
        'וואו, ארבע כבר',
      ...
      5: [
        // Fifth rebuy - serious (15+ messages)
        'חמש כבר, רציני',
        'ערב יקר הולך להיות',
        'בטוח שכדאי להמשיך',
        'חמש זה הרבה',
    ...
    // Messages for 6-8 rebuys (expanded)
    const highMessages = [
      'שיא אישי בדרך',
      'נו באמת, מספיק',
      'שוברים שיאים הלילה',
    ...
    // Messages for 9+ rebuys (expanded)
    const finalMessages = [
      'בבקשה לעצור',
      'מספיק להיום',
      'די, נגמר',
