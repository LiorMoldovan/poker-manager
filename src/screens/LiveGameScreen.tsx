...
const LiveGameScreen = () => {
  ...
  const getBuyinMessage = (totalBuyins: number, isQuickRebuy: boolean): string => {
    ...
    const messages: Record<number, string[]> = {
      2: [
        ...
        'קנייה שנייה, מכאן הכל פתוח, הערב עוד צעיר',
        'מתחילים מחדש, היד הבאה יכולה להיות זו שתשנה הכל',
      ],
      3: [
        ...
        'שלוש קניות, גם אלופים נכנסים מאחור, הסבלנות משתלמת',
        'הקלפים מתחממים, רגע הזהב מרגיש קרוב',
      ],
      4: [
        ...
        'ארבע קניות, יד אחת טובה והכל מתהפך, זה קורה מהר',
        'מי שמתמיד מנצח, היד הגדולה מרגישה ממש מעבר לפינה',
      ],
      5: [
        ...
        'חמש קניות, הקאמבקים הכי טובים מתחילים בדיוק מכאן',
        'עוד לא נגמר, יד אחת חזקה והסיפור מתהפך לטובה',
      ],
      6: [
        ...
        'שש קניות, אלופים לא נשברים, הערב עוד יכול להתהפך',
        'הנחישות הזאת משתלמת בסוף, ממשיכים בראש מורם',
      ],
    };
    ...
    const highMessages = [
      ...
      'כל הכבוד על הרוח הלוחמת, יד אחת והכל משתנה',
      'מי שלא מוותר מקבל את הרגע הגדול, ממשיכים חזק',
    ];
    ...
    const finalMessages = [
      ...
      'המחויבות הזאת ראויה להערכה, רגע אחד יכול להפוך הכל',
      'אלוף אמיתי נמדד ביכולת לא לוותר, הכבוד כולו שלך',
    ];
  ...
  const getPersonalMessage = (
    ...
    try {
      ...
      messages.push(`${playerName} עם ${wc} נצחונות מאחורי הגב, היד הגדולה יכולה לבוא בכל רגע`);
      messages.push(`רוח לוחמת אצל ${playerName}, ${formatBuyins(currentGameRebuys)} קניות ועדיין ${g('מאמין', 'מאמינה')} בגדול`);
