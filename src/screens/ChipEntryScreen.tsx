...
import { calculateChipTotal, calculateProfitLoss } from '../utils/calculations';
        ...
        <div className="grid grid-2" style={{ gap: '1.5rem' }}>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              ₪{(totalChipPoints * valuePerChip).toFixed(2)}
            </div>
            <div style={{ 
              fontSize: '1.1rem', 
              fontWeight: '700',
        ...
        {!isBalanced && totalChipPoints > 0 && (
          <div style={{ 
            ...
            <span style={{ color: totalChipPoints > expectedChipPoints ? '#dc2626' : '#b45309', fontWeight: '700' }}>
              ...
              ({totalChipPoints > expectedChipPoints ? '+' : '-'}₪{Math.abs((totalChipPoints - expectedChipPoints) * valuePerChip).toFixed(2)})
            </span>
          </div>
        )}
        {isBalanced && totalChipPoints > 0 && (
      ...
      <div className="card" style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.5rem' }}>
          <div>
            ...
            <div style={{ fontWeight: '800', color: '#0c4a6e', fontSize: '1.1rem' }}>₪{totalBuyIns.toFixed(2)}</div>
