...
- אם קלפי לוח מוזכרים ב-situation — חלץ אותם ל-boardCards וקצר את situation.
- אם boardCards ריק אבל יש קלפי לוח ב-situation — חלץ אותם ל-boardCards.
- אם situation אומר "יש לך פלאש דרו/סט/סטרייט/זוגות על הלוח" — הסר את זה. השחקן רואה קלפים בנפרד וצריך לזהות בעצמו.
...
nearMiss: סמן תשובות שגויות שהיו נכונות בפוקר מקצועי אבל לא במשחק ביתי (nearMiss:true רק על isCorrect:false).

לוגיקה פוקרית: בדוק שהתשובה הנכונה באמת נכונה — קלפים ביד + לוח לא יוצרים יד חזקה יותר שלא זוהתה? סכומי הימור הגיוניים? אין קלפים כפולים?
