...
הדרישה המרכזית: כל משפט חייב להיות ספציפי לשחקן ולמצב. אסורים משפטים גנריים שאפשר להגיד על כל אחד. עדיפות ראשונה: נתונים סטטיסטיים אמיתיים — אחוז נצחונות, רווח/הפסד כולל, רצפים, שיאים, ממוצע קניות, מספר משחקים. עדיפות שנייה (במיעוט): עובדה אישית אחת בלבד — עבודה, קבוצה, או תכונה. אסור לשלב יותר מעובדה אישית אחת באותו משפט.
...
2. עדיפות לנתונים סטטיסטיים: רוב המשפטים חייבים להשתמש בנתונים אמיתיים כמו אחוז נצחונות, רווח/הפסד כולל, רצף, שיא רווח/הפסד, ממוצע קניות, מספר משחקים. עובדות אישיות (עבודה/קבוצה) מותרות במיעוט בלבד, ותמיד רק עובדה אחת בודדת לכל משפט.
...
"players" — לכל שחקן (${playerNamesList}):
  "generic": 6 משפטים — כל אחד חייב להיות ספציפי לשחקן הזה ורק לו. לפחות 4 מתוכם עם {COUNT}. חובה: לפחות 4 מתוך 6 מבוססים על נתונים סטטיסטיים. מקסימום 2 על עובדה אישית (ורק עובדה אחת בודדת לכל משפט).
