...
export const generateAIForecasts = async (
  ...
  const prompt = `פרשן פוקר יצירתי. כתוב משפט ייחודי ומעניין לכל שחקן.
🎲 ${randomSeed}
...
🚫 אסור לכתוב (משעמם ושחוק!):
• "עם ממוצע של X₪ ב-Y משחקים"
• "מקום X מתוך Y"
• "מדורג במקום"
• "ב-H1/H2 2025/2026"
• כל משפט עם מבנה זהה לאחרים

✨ דוגמאות מגוונות (כל אחד שונה לחלוטין!):
{"name":"דני", "highlight":"רצף 3 נצחונות 🔥", "sentence":"בענק! קשה לעצור אותו כרגע.", "expectedProfit":85}
{"name":"יוסי", "highlight":"חזרה אחרי 45 ימים", "sentence":"ההפסקה הייתה ארוכה, צריך לחמם מנועים.", "expectedProfit":-40}
{"name":"מיכל", "highlight":"הפסד -180₪ אחרון", "sentence":"מחפשת נקמה הלילה.", "expectedProfit":30, "isSurprise":true}
{"name":"אבי", "highlight":"מוביל הטבלה 👑", "sentence":"המלך על הכס, אבל כולם רודפים.", "expectedProfit":60}
{"name":"רון", "highlight":"נצחון +280₪ אחרון", "sentence":"הביטחון בשיא, מסוכן במיוחד.", "expectedProfit":50}
{"name":"שי", "highlight":"5 הפסדים ברצף 📉", "sentence":"חייב לשבור את הרצף השחור.", "expectedProfit":-30}
{"name":"גל", "highlight":"ממוצע +95₪ 💰", "sentence":"שקט אבל קטלני.", "expectedProfit":70}
{"name":"נועה", "highlight":"קרובה לאלף! 🎯", "sentence":"עוד 80₪ לשבור את המחסום.", "expectedProfit":45}

⚠️ כללים:
• סכום expectedProfit = 0 בדיוק
• צפי קרוב לנתונים (±30₪)
• מור = נקבה
• משפט קצר (5-12 מילים), ללא מספרים מיותרים
• כל משפט מתחיל ונשמע אחרת!

📝 JSON בלבד:
[{"name":"שם", "expectedProfit":מספר, "highlight":"3-5 מילים", "sentence":"קצר וקולע", "isSurprise":bool}]`;
