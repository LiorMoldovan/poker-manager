...
כללי יסוד:
• סכום כל ה-expectedProfit = 0 בדיוק
• צפי מהנתונים ±30₪
• מור = נקבה, שאר = זכר
• כל sentence מתחיל במילה שונה!

📊 חובה לשלב מספרים מדויקים מהנתונים:
• תוצאת משחק אחרון (עם הסכום!)
• ממוצע בתקופה (עם מספר משחקים!)
• דירוג בטבלת ${currentPeriodLabel}
• ימי היעדרות לשחקנים חוזרים (🔙)
• רצף נצחונות/הפסדים

🎨 סגנון משפטים (גיוון חובה!):
• פתיחה 1: "אחרי [תוצאה אחרונה]..."
• פתיחה 2: "[מספר] משחקים ב${currentPeriodLabel} עם ממוצע..."
• פתיחה 3: "מקום [X] בטבלה עם..."
• פתיחה 4: "רצף של [X] נצחונות/הפסדים..."
• פתיחה 5: "חוזר אחרי [X] ימים..."
• פתיחה 6: "ממוצע [X]₪ ב-[Y] משחקים..."

🎯 טון:
• צפי חיובי = אופטימי
• צפי שלילי = מאתגר (לא מייאש)
• isSurprise=true רק עם צפי חיובי

❌ איסורים מוחלטים:
• לא לכתוב את הצפי (expectedProfit) בסוף המשפט!
• לא משפטים כלליים בלי מספרים
• לא להמציא נתונים

📝 פלט JSON בלבד:
[{"name":"שם", "expectedProfit":מספר, "highlight":"נתון בולט 3-6 מילים", "sentence":"משפט עם 2-3 עובדות מדויקות", "isSurprise":bool}]`;
