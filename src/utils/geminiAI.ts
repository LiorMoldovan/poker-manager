...
═══════════════════════════════════════════════════════════════════
📝 דוגמאות לפלט טוב (שים לב - סיומים מגוונים, בלי שאלות!):
═══════════════════════════════════════════════════════════════════

{"name":"דני", "expectedProfit":85, "highlight":"🔥 רצף חם", "sentence":"3 נצחונות רצופים עם ממוצע +92₪. הפייבוריט של הערב.", "isSurprise":false}
{"name":"יוסי", "expectedProfit":-60, "highlight":"זמן לחזור", "sentence":"3 הפסדים רצופים, אבל ההיסטוריה שלו מראה שהוא יודע להפתיע.", "isSurprise":false}
{"name":"מיכל", "expectedProfit":45, "highlight":"⭐ מועמדת להפתעה", "sentence":"למרות היסטוריה קשה, הפורמה האחרונה מרשימה מאוד.", "isSurprise":true}
{"name":"אבי", "expectedProfit":70, "highlight":"👑 מקום ראשון", "sentence":"מוביל בטבלה עם ממוצע +110₪. קשה להמר נגדו.", "isSurprise":false}
{"name":"רון", "expectedProfit":-30, "highlight":"חוזר מהפסקה", "sentence":"לא שיחק חודשיים - צריך זמן להתחמם מחדש.", "isSurprise":false}
{"name":"שי", "expectedProfit":-50, "highlight":"בחיפוש אחר ניצחון", "sentence":"תקופה קשה אבל הניסיון שלו עוד יעזור לו.", "isSurprise":false}
...
3. כל שחקן - highlight ו-sentence שונים לגמרי!
4. highlight = 2-4 מילים, קצר וקולע
5. sentence = משפט אחד מרתק, סיום חד (לא שאלה!)
6. isSurprise=true רק לשחקן עם היסטוריה גרועה + פורמה טובה
7. מספרים שלמים בלבד
8. עברית, לשון זכר (חוץ ממור = נקבה)

🚫 איסורים:
- מקסימום שחקן אחד יכול להסתיים בשאלה (?) - השאר סיום חד!
- אל תמציא עובדות כמו "הממוצע הגבוה ביותר"
- אל תכתוב "מוביל" אלא אם הדירוג = מקום 1
- רק מספרים מהנתונים!
